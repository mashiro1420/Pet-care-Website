...
Route::middleware(['kiem.tra:1'])->group(function (){
    //TaiKhoan Routes
...
Route::middleware(['kiem.tra:2'])->group(function (){
    //KhachHangChamSoc
...
Route::middleware(['kiem.tra:1,3'])->group(function (){
    //QLChamSoc Routes
...
Route::middleware(['kiem.tra:1,3,5'])->group(function (){
    //BaiDang Routes
