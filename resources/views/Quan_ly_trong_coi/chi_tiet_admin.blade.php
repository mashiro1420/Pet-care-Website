...
<head>
  ...
  <title>Chi tiết lịch trông coi</title>
...
<body>
  ...
  <div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h3 class="mb-0">Chi tiết lịch trông coi</h3>
      <a href="{{url('ql_trongcoi')}}" class="btn btn-outline-secondary">
        ...
        <form action="{{ url('xl_xac_nhan_tc') }}" method="POST">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="trang_thai" value="{{$trong_coi->ten_trang_thai}}" readonly>
              </div>
            </div> 
          </div>
          <div class="row g-3">
          ...
          <div class="form-group">
            ...
            @endphp
              ...
              <select class="js-example-basic-multiple form-control" name="dich_vu_them[]" id="dich_vu_them" multiple='multiple' {{ $trong_coi->id_trang_thai==1||$trong_coi->id_trang_thai==2?'required':'readonly' }}>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="khuyen_mai" value="{{$trong_coi->ten_khuyen_mai}}" readonly>
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
