...
<head>
  ...
  <title>PetCare - Chi tiết lịch chăm sóc</title>
...
<body>
  ...
  <section class="main-content">
    <div class="container" id="form-section">
      <h2 class="form-title">Chi tiết lịch chăm sóc</h2>
      <form action="" method="">
        @csrf
        <div class="row g-3">
            <div class="col-md-6">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="thumb_nail" value="{{$cham_soc->ten_trang_thai}}" readonly>
            </div>
          </div> 
        </div>
        <div class="row g-3">
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="tai_khoan" value="{{$cham_soc->tai_khoan}}" readonly> 
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
              <label for="trang_thai" class="form-label">Ngày chăm sóc</label>
              <input type="date" class="form-control" name="ngay" value="{{$cham_soc->ngay}}">
            </div>
          </div>
        </div>
        <div class="row g-3">
