                ...
                <label for="loai_noi_dung" class="form-label required-field">Loại nội dung</label>
                  <select class="form-select" name="loai_noi_dung" required>
                    @foreach ($loai_noi_dungs as $loai_noi_dung)
                      <option value="{{ $loai_noi_dung->id }}" {{ $bai_dang->id_loai_noi_dung==$loai_noi_dung->id?"selected":"" }}>
                        {{ $loai_noi_dung->ten_loai_noi_dung }}
                      </option>
                    @endforeach
                  </select> 
              </div>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="link_video" value="{{$bai_dang->link_video}}">
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
