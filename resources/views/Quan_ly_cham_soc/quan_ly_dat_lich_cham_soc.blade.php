...
<head>
  ...
  <title>Quản lý lịch chăm sóc</title>
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
          <nav aria-label="Page navigation">
            <ul class="pagination mb-0">
              ...
              @else
                <li class="page-item">
                  <a class="page-link" href="{{ $cham_socs->previousPageUrl() }}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                  </a>
                </li>
              @endif
              ...
              @if ($cham_socs->hasMorePages())
                <li class="page-item">
                  <a class="page-link" href="{{ $cham_socs->nextPageUrl() }}" aria-label="Next">
